...
def queryset_func(request, data_structure_name,model_class):
...
def update_object(request, data_structure_name, object_id, new_value,updated_field):
...
def delete_person(request, data_structure_name, object_id):

    cache.delete(data_structure_name, object_id)